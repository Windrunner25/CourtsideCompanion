<template>
    <v-container class="stat-table pa-4"  id="report">
      ...
      <v-row>
        <v-col class="stat-header"> </v-col>       
        <v-col class="stat-header"> </v-col>
        <v-col class="stat-header">All</v-col>
        <v-col class="stat-header">Set 1</v-col>
        <v-col class="stat-header">Set 2</v-col>
        <v-col class="stat-header" style="border-right: 1px solid black;">Set 3</v-col>
        <v-col class="stat-header">All</v-col>
        <v-col class="stat-header">Set 1</v-col>
        <v-col class="stat-header">Set 2</v-col>
        <v-col class="stat-header">Set 3</v-col>
      </v-row>
      <v-row>
    ...
    <v-row>
      <v-col class="stat-header">Rally Length</v-col>       
        <v-col class="stat-header"> </v-col>
        <v-col class="stat-header">All</v-col>
        <v-col class="stat-header">Set 1</v-col>
        <v-col class="stat-header">Set 2</v-col>
