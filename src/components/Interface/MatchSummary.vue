    ...
    async press() {
      ...
      try {
        ...
        if (result.length >= 1 && result[0].obj) {
          ...
          this.matchSummary[player1].count1 = count1;
          this.matchSummary[player1].intent1 = obj1["Stroke Intent"] || "N/A";
          this.matchSummary[player1].strokeSide1 = obj1["Stroke Side"] || "N/A";
          this.matchSummary[player1].strokeType1 = obj1["Stroke Type"] || "N/A";
          this.matchSummary[player1].errorLocation1 =
        ...
        if (result.length >= 2 && result[1].obj) {
          ...
          this.matchSummary[player1].count2 = count2;
          this.matchSummary[player1].intent2 = obj2["Stroke Intent"] || "N/A";
          this.matchSummary[player1].strokeSide2 = obj2["Stroke Side"] || "N/A";
          this.matchSummary[player1].strokeType2 = obj2["Stroke Type"] || "N/A";
          this.matchSummary[player1].errorLocation2 =
